...
namespace mes
{
	...
	{  /*  name         offtype  version   uint8x2         uint8str        string          encstr          uint16x4      enckey  output strings... */
		...
		{ "cdcd"      , offset1, 0x3963, { 0x00, 0x2B }, { 0xFF, 0xFF }, { 0x2C, 0x48 }, { 0x49, 0x4C }, { 0x4D, 0xFF },  0x20, { 0x45, 0x31 }/*---*/}, // Circus Disk ～Christmas Days～
		{ "cdcd2"     , offset1, 0x4D69, { 0x00, 0x29 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF },  0x20, { 0x45 }/*---------*/}, // Circus Disk ～Christmas Days～
