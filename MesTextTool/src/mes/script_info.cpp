...
namespace mes
{
	...
	{  /*  name         offtype  version   uint8x2         uint8str        string          encstr          uint16x4      enckey  output strings... */
		...
		{ "homemaidt" , offset1, 0x1A66, { 0x00, 0x2E }, { 0xFF, 0xFF }, { 0x2F, 0x4B }, { 0x4C, 0x4F }, { 0x50, 0xFF },  0x20, {/*--*/}/*---------*/}, // ホームメイド -Home maid- 体験版
		...
		{ "utaeho5"   , offset1, 0x0062, { 0x00, 0x2E }, { 0xFF, 0xFF }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF },  0x20, {/*--*/}/*---------*/}, // うたう絵本５
		{ "utaeho6"   , offset1, 0x2466, { 0x00, 0x2E }, { 0xFF, 0xFF }, { 0x2F, 0x4B }, { 0x4C, 0x4F }, { 0x50, 0xFF },  0x20, {/*--*/}/*---------*/}, // うたう絵本６
	};
